...
export default async function LoginPage({
  ...
  return (
    <main className="mx-auto w-full max-w-375 overflow-x-hidden px-4 py-6 sm:px-8 lg:flex lg:min-h-screen lg:px-10 xl:px-14 2xl:px-20">
      <section className="grid w-full gap-6 lg:flex-1 lg:grid-cols-[1.05fr_0.95fr] xl:grid-cols-[1.18fr_0.82fr] xl:gap-10 2xl:gap-14">
        <div className="relative hidden overflow-hidden rounded-[2.2rem] border border-[rgba(246,196,79,0.14)] bg-[linear-gradient(145deg,rgba(32,24,21,0.98),rgba(27,19,17,0.96),rgba(20,14,12,0.98))] text-stone-100 shadow-[0_28px_90px_rgba(24,16,13,0.28)] backdrop-blur lg:block">
          <Image
            src="/img_login.png"
        ...
        <aside className="w-full rounded-[2.2rem] border border-line bg-[linear-gradient(180deg,#201815,#17100e)] p-6 text-stone-100 shadow-[0_28px_90px_rgba(24,16,13,0.2)] md:p-8 xl:p-9 2xl:sticky 2xl:top-10 2xl:self-start">
